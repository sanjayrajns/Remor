...
export default function AllItemsView({ onOpenQuickCapture }) {
    ...
    <div style={{ flex: 1, padding: '24px 32px', overflowY: 'auto' }}>
      <div style={{ marginBottom: '24px', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '16px' }}>
        <div>
          ...
          <p className="text-secondary text-sm" style={{ marginTop: '4px' }}>
            Your entire personal library of links, notes, tasks, ideas, and references.
          </p>
        </div>
      ...
      {items.length === 0 ? (
        <EmptyState
          ...
          description="Try broadening your search query or clear filters to view items."
